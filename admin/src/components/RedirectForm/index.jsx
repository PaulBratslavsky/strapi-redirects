      ...
      if (!formik.dirty) {
        ...
        toggleNotification({
          ...
          message: formatMessage({
            id: getTrad('detail.form.save.notify.error.update.message'), // is this what I need to do?
            defaultMessage: formatMessage({ id: getTrad('detail.form.save.notify.error.update.message') }),
          }),
        });
        return;
      }
