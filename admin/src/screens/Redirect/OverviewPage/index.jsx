...
import { useFetchClient, Pagination } from '@strapi/strapi/admin';


// import { EmptyBodyTable, PaginationURLQuery, PageSizeURLQuery } from '@strapi/helper-plugin'; // ask the team about this
import {
  Box,
  Table,
  Tbody,
...
const RedirectOverviewPage = () => {
  ...
  const handleRowClick = (id) => {
    // history.push(`/plugins/${PLUGIN_ID}/${id}`);
  };
  ...
  const handleNewRedirect = () => {
    // history.push(`/plugins/${PLUGIN_ID}/new`);
  };
