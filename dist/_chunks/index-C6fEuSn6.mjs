...
import { P as PLUGIN_ID } from "./index-B8hp5SUT.mjs";
...
const RedirectOverviewPage = () => {
  return /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx("h1", { children: "Hello Mom 2" }) });
};
const OverviewPage = memo(RedirectOverviewPage);
var map;
try {
  map = Map;
} catch (_) {
...
const RedirectDetailPage = () => {
  ...
  useNotification();
  const [redirect, setRedirect] = useState(void 0);
  useState(0);
  ...
  return /* @__PURE__ */ jsx("h1", { children: "fix the detail page" });
};
const DetailPage = memo(RedirectDetailPage);
const App = () => {
  return /* @__PURE__ */ jsxs(Routes, { children: [
    /* @__PURE__ */ jsx(Route, { path: "/", element: /* @__PURE__ */ jsx(OverviewPage, {}) }),
    /* @__PURE__ */ jsx(Route, { path: `/${PLUGIN_ID}/new`, element: /* @__PURE__ */ jsx(DetailPage, {}) }),
    /* @__PURE__ */ jsx(Route, { path: `/${PLUGIN_ID}/:id`, element: /* @__PURE__ */ jsx(DetailPage, {}) })
  ] });
};
export {
  App as default
};
//# sourceMappingURL=index-C6fEuSn6.mjs.map
